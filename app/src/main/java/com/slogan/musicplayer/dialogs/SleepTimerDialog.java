package com.slogan.musicplayer.dialogs;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        materialDialog = new MaterialDialog.Builder(getActivity())
                ...
                .onPositive((dialog, which) -> {
                    ...
                    Toast.makeText(getActivity(), getActivity().getResources().getQuantityString(R.plurals.sleep_timer_set, minutes, minutes), Toast.LENGTH_SHORT).show();
                })
