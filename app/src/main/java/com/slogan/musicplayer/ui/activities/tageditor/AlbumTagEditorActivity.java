package com.slogan.musicplayer.ui.activities.tageditor;
...
import com.slogan.musicplayer.glide.palette.BitmapPaletteTranscoder;
...
import com.slogan.musicplayer.util.LastFMUtil;
...
public class AlbumTagEditorActivity extends AbsTagEditorActivity implements TextWatcher {
    ...
    protected void loadCurrentImage() {
        ...
        setImageBitmap(bitmap, MusicColorUtil.getColor(MusicColorUtil.generatePalette(bitmap), ATHUtil.resolveColor(this, R.attr.defaultFooterColor)));
