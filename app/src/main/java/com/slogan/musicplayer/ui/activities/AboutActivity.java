...
public class AboutActivity extends AbsBaseActivity implements View.OnClickListener {
    ...
    private static String GITHUB = "https://github.com/kayung-developer/Music-Player";
    ...
    public void onClick(View v) {
        if (v== licenses) {
            ...
            intent.setData(Uri.parse("mailto:xipdevapps@gmail.com"));
            intent.putExtra(Intent.EXTRA_EMAIL, "xipdevapps@gmail.com");
