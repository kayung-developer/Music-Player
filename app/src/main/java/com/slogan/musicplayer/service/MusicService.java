package com.slogan.musicplayer.service;
...
import com.slogan.musicplayer.appwidgets.AppWidgetBig;
import com.slogan.musicplayer.appwidgets.AppWidgetCard;
import com.slogan.musicplayer.appwidgets.AppWidgetCardDark;
import com.slogan.musicplayer.appwidgets.AppWidgetClassic;
import com.slogan.musicplayer.appwidgets.AppWidgetClassicDark;
import com.slogan.musicplayer.appwidgets.AppWidgetSmall;
import com.slogan.musicplayer.appwidgets.AppWidgetSmallDark;
import com.slogan.musicplayer.glide.BlurTransformation;
import com.slogan.musicplayer.glide.SongGlideRequest;
import com.slogan.musicplayer.helper.ShuffleHelper;
import com.slogan.musicplayer.helper.StopWatch;
import com.slogan.musicplayer.loader.PlaylistSongLoader;
import com.slogan.musicplayer.model.AbsCustomPlaylist;
...
import com.slogan.musicplayer.provider.MusicPlaybackQueueStore;
import com.slogan.musicplayer.provider.SongPlayCountStore;
import com.slogan.musicplayer.service.notification.PlayingNotification;
import com.slogan.musicplayer.service.notification.PlayingNotificationImpl;
import com.slogan.musicplayer.service.notification.PlayingNotificationImpl24;
import com.slogan.musicplayer.service.playback.Playback;
import com.slogan.musicplayer.util.MusicUtil;
import com.slogan.musicplayer.util.PreferenceUtil;
import com.slogan.musicplayer.util.Util;
...
public class MusicService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener, Playback.PlaybackCallbacks {
    ...
    public static final String MUSIC_PACKAGE_NAME = "com.slogan.musicplayer";
    ...
    public void onCreate() {
        ...
        sendBroadcast(new Intent("com.slogan.musicplayer.MUSIC_SERVICE_CREATED"));
    }
                    ...
                    case ACTION_PLAY_PLAYLIST:
                        ...
                        if (playlist != null) {
                            ...
                            if (playlist instanceof AbsCustomPlaylist) {
                                ...
                                playlistSongs = (List<Song>) (List) PlaylistSongLoader.getPlaylistSongList(getApplicationContext(), playlist.id);
                            }
    ...
    public void onDestroy() {
        ...
        sendBroadcast(new Intent("com.slogan.musicplayer.MUSIC_SERVICE_DESTROYED"));
    }
        ...
        public void handleMessage(@NonNull final Message msg) {
            ...
            switch (msg.what) {
                ...
                case SONG_WENT_TO_NEXT:
                    if (service.pendingQuit || service.getRepeatMode() == REPEAT_MODE_NONE && service.isLastSong()) {
                        service.pause();
                        service.seek(0);
