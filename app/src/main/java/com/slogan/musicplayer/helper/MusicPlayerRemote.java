...
public class MusicPlayerRemote {
    ...
    public static boolean playNext(@NonNull List<Song> songs) {
        if (musicService != null) {
            ...
            final String toast = songs.size() == 1 ? musicService.getResources().getString(R.string.added_title_to_playing_queue) : musicService.getResources().getQuantityString(R.plurals.added_x_titles_to_playing_queue, songs.size(), songs.size());
