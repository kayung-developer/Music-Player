package com.slogan.musicplayer.appshortcuts.shortcuttype;
...
import com.slogan.musicplayer.appshortcuts.AppShortcutLauncherActivity;

@TargetApi(Build.VERSION_CODES.N_MR1)
public abstract class BaseShortcutType {

    static final String ID_PREFIX = "com.slogan.musicplayer.appshortcuts.id.";
